...
public final class ContextColorSchemeProvider implements ColorSchemeProvider {
    ...
    public ContextColorSchemeProvider(@NotNull Context context2) {
        ...
        } else if (PushwooshInboxStyle.INSTANCE.getDefaultImageIcon() != -1) {
            drawable2 = ContextCompat.getDrawable(this.context, PushwooshInboxStyle.INSTANCE.getDefaultImageIcon());
            if (drawable2 == null) {
                drawable2 = loadIcon;
            }
