...
public class RegistrationPrefs {
    ...
    RegistrationPrefs(d dVar, d dVar2) {
        PWLog.noise("RegistrationPrefs()...");
        this.config = dVar;
        this.deviceRegistrar = dVar2;
        ...
        if (this.applicationId.get().isEmpty() && dVar.a() != null) {
            this.applicationId.set(dVar.a());
        }
        this.projectId = new PreferenceStringValue(providePrefs, PROPERTY_PROJECT_ID, "");
        if (this.projectId.get().isEmpty() && dVar.b() != null) {
            this.projectId.set(dVar.b());
        }
        ...
        this.logLevel = new PreferenceStringValue(providePrefs, PROPERTY_LOG_LEVEL, dVar.d());
