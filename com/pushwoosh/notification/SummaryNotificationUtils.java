...
public class SummaryNotificationUtils {
    ...
    private static SummaryNotificationFactory b() {
        try {
            Class<?> cls = RepositoryModule.getNotificationPreferences().g().get();
            if (cls != null) {
    ...
    public static Notification getSummaryNotification(int i) {
        ...
        onGenerateSummaryNotification.contentIntent = PendingIntent.getBroadcast(applicationContext, 20191017, notificationIntent, 268435456);
